...
public class JpaQueryUtil {
    ...
    public static String generateCreationQuery(String tableName, int countOfColumns) {
        return "INSERT INTO " + tableName + " VALUES(default" + ",?".repeat(Math.max(0, countOfColumns)) + ");";
    }

    public static String generateManyToManyCreationQuery(String tableName) {
        return "INSERT INTO " + tableName + " VALUES(?,?);";
    }

    public static String generateDeletionQuery(String tableName, String columnName, String predicate) {
    ...
    public static String generateDeletionByPredicates(String tableName, Map<String, String> columnWithPredicates) {
    ...
    public static <E extends AbstractEntity> String generateUpdateQueryByUuid(String tableName, Class<E> clazz, UUID uuid, String[] excludeFields) {
        ...
        for (int columnIndex = 0; columnIndex < columns.size(); columnIndex++) {
            ...
            if (!currentColumn.equals("id") && isValid) {
                query.append(" ").append(fromCamelCaseToSnakeCase(currentColumn)).append(" = ?");
    ...
    public static <E extends AbstractEntity> String generateFindingQuerySecondEntityByFirstEntityIdOnAdjacentTable(
            Long firstEntityId,
            Class<E> secondClazz,
